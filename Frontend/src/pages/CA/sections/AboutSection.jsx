      ...
      <div className="main">
        <div className="slideshow-wrapper">
          <div className="slideshow">
            <img
              src="https://firebasestorage.googleapis.com/v0/b/zeitgeist-23.appspot.com/o/Resources%2FCA%2Fresources%2FaboutPic.png?alt=media&token=86fdbc75-487c-4710-b014-f0790667d1b9"
              alt=""
            />
          </div>
        </div>
